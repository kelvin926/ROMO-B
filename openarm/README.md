...
- OpenArm-v1 원본 캘리브레이션 관절 좌표를 명령·피드백에 그대로 사용하고,
  공식 bimanual URDF의 좌우 하드 범위를 적용: 왼팔 J1 -200~80°, J2
  -190~10° / 오른팔 J1 -80~200°, J2 -10~190°. J3~J7과 gripper는 좌우 동일
...
- 저장 자세 JSON 내보내기/가져오기를 통한 다른 노트북·연구원 간 전달
  (좌표 schema v3; 잘못된 오른팔 부호 반전을 사용한 schema v2 자세는 불러올
  때 원본 OpenArm-v1 좌표로 한 번 자동 복원)
